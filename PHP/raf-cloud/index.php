...
<div class="container d-flex h-100 ">
    <div class="mx-auto align-self-center text-center">
        ...
        <?php if (isset($_SESSION['loginErr'])): ?>
            <span class="m-1" style="color: darkred"><?= $_SESSION['loginErr'] ?></span>
        ...
        <form action="login.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="password" id="passwordUnos" class="form-control" placeholder="Password..." required>
            </div>
            <p>Ako nemas nalog, <a href="register.php">registruj se</a> !</p>
