...
namespace uskladisteneProcedureCRUD
{
    public partial class Unos : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (konekcija = new SqlConnection(konekcioniString))
            {
                komanda = new SqlCommand("exec LetilicaInsert @regbr, @tip, @naziv, @opis", konekcija);
                ...
                try
                {
                    ...
                    MessageBox.Show("Uspesno ste uneli Letilicu u bazu", "INFORMACIJA", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }

                catch (Exception)
                {
                    //MessageBox.Show(ex.ToString());
                    MessageBox.Show("Greska, Letilica nije unesena!", "GRESKA", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
